        ...
        <li className="nav-item">
          ...
          <ul className="nav nav-treeview">
            ...
            <li className="nav-item tree-1">
                ...
                <ul className="nav nav-treeview">
                  <li className="nav-item tree-2" onClick={() => changeContent('History_transferable')}>
                    <a  className={activeItem === 'History_transferable' ? 'nav-link active' : 'nav-link'} >
                      <i className="far fa-circle nav-icon" />
                      <p>Histori Transferabilitas</p>
                    </a>
                  </li>
                  <li className="nav-item tree-2" onClick={() => changeContent('Transferable')}>
                    <a  className={activeItem === 'Transferable' ? 'nav-link active' : 'nav-link'} >
                      <i className="far fa-circle nav-icon" />
                      <p>Transferable</p>
                    </a>
                  </li>
                  <li className="nav-item tree-2" onClick={() => changeContent('Laporan_status_transferable')}>
                    <a  className={activeItem === 'Laporan_status_transferable' ? 'nav-link active' : 'nav-link'} >
                      <i className="far fa-circle nav-icon" />
        ...
        <li className="nav-item">
          ...
          <ul className="nav nav-treeview">
            <li className="nav-item tree-1">
                ...
                <ul className="nav nav-treeview">
                  <li className="nav-item tree-2" onClick={() => changeContent('Nama')}>
                    <a  className={activeItem === 'Nama' ? 'nav-link active' : 'nav-link'} >
                      <i className="far fa-circle nav-icon" />
                      <p>Nama</p>
                    </a>
                  </li>
                  <li className="nav-item tree-2" onClick={() => changeContent('Nippos')}>
                    <a  className={activeItem === 'Nippos' ? 'nav-link active' : 'nav-link'} >
                      <i className="far fa-circle nav-icon" />
                      <p>Nippos</p>
                    </a>
                  </li>
                  <li className="nav-item tree-2" onClick={() => changeContent('Kriteria')}>
                    <a  className={activeItem === 'Kriteria' ? 'nav-link active' : 'nav-link'} >
                      <i className="far fa-circle nav-icon" />
                      <p>Kriteria</p>
                    </a>
                  </li>
            ...
            <li className="nav-item tree-1">
                ...
                <ul className="nav nav-treeview">
                  <li className="nav-item tree-2" onClick={() => changeContent('Lama_menjabat')}>
                    <a  className={activeItem === 'Lama_menjabat' ? 'nav-link active' : 'nav-link'} >
                      <i className="far fa-circle nav-icon" />
                      <p>Lama Menjabat</p>
                    </a>
                  </li>
                  <li className="nav-item tree-2" onClick={() => changeContent('Status_cltp')}>
                    <a  className={activeItem === 'Status_cltp' ? 'nav-link active' : 'nav-link'} >
                      <i className="far fa-circle nav-icon" />
                      <p>Status CLTP</p>
                    </a>
                  </li>
            ...
            <li className="nav-item tree-2" onClick={() => changeContent('Peg12_umum')}>
              <a  className={activeItem === 'Peg12_umum' ? 'nav-link active' : 'nav-link'} >
                <i className="far fa-circle nav-icon" />
                <p>Peg12 Umum</p>
              </a>
            </li>
            <li className="nav-item tree-2" onClick={() => changeContent('Profiling_peg12')}>
              <a  className={activeItem === 'Profiling_peg12' ? 'nav-link active' : 'nav-link'} >
                <i className="far fa-circle nav-icon" />
                <p>Profiling Peg12</p>
              </a>
            </li>
            <li className="nav-item tree-2" onClick={() => changeContent('Pencarian_peg12')}>
              <a  className={activeItem === 'Pencarian_peg12' ? 'nav-link active' : 'nav-link'} >
                <i className="far fa-circle nav-icon" />
                <p>Pencarian Peg12</p>
              </a>
            </li>
